        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              >
                <svg viewBox="0 0 135 40" className="h-12 w-auto" role="img" aria-hidden="true">
                  <rect width="135" height="40" rx="5" fill="#000"/>
                  <rect x="0.5" y="0.5" width="134" height="39" rx="4.5" fill="none" stroke="#A6A6A6" strokeOpacity="0.5"/>
                  <path d="M27.6 20.3c0-2.2 1.8-3.3 1.9-3.4-1-1.5-2.6-1.7-3.2-1.7-1.3-.1-2.6.8-3.3.8-.7 0-1.7-.8-2.8-.8-1.5 0-2.8.8-3.6 2.1-1.5 2.6-.4 6.5 1.1 8.6.7 1 1.5 2.2 2.6 2.2 1 0 1.5-.7 2.7-.7 1.2 0 1.6.7 2.7.7 1.1 0 1.8-1 2.5-2 .8-1.2 1.1-2.3 1.1-2.3-.1 0-2.2-.8-2.2-3.3zm-2.2-6.2c.6-.7 1-1.7.9-2.7-.8 0-1.9.6-2.5 1.3-.5.6-1 1.6-.9 2.5.9.1 1.9-.5 2.5-1.1z" fill="#fff"/>
                  <text x="44" y="16" fill="#fff" fontSize="7" fontFamily="-apple-system,Helvetica,Arial,sans-serif">Download on the</text>
                  <text x="44" y="31" fill="#fff" fontSize="15" fontWeight="600" fontFamily="-apple-system,Helvetica,Arial,sans-serif">App Store</text>
                </svg>
              </a>
              <a
