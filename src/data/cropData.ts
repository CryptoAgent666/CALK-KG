...
// Урожайность зерновых и картофеля — Нацстатком КР, итоги 2024:
// пшеница 27.7 ц/га, ячмень 24.7 ц/га, картофель 178.7 ц/га (stat.gov.kg).
// По овощам официальной пер-культурной статистики нет — средние иллюстративные.
// 
...
export const CROPS: CropType[] = [
  // === ЗЕРНОВЫЕ ===
  {
    ...
    nameKey: 'crop_wheat',
    category: 'grain',
    avgYield: 2.8, // т/га (Нацстатком 2024: 27.7 ц/га)
    minYield: 2.0,
    maxYield: 5.5,
  ...
  },
  {
    ...
    nameKey: 'crop_barley',
    category: 'grain',
    avgYield: 2.5, // т/га (Нацстатком 2024: 24.7 ц/га)
    minYield: 1.8,
    maxYield: 4.8,
    seedCost: 7000,
  ...
  // === КОРНЕПЛОДЫ ===
  {
    ...
    nameKey: 'crop_potato',
    category: 'root',
    avgYield: 18, // т/га (Нацстатком 2024: 178.7 ц/га)
    minYield: 12,
    maxYield: 35,
