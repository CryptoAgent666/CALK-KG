...
// Источник: приказ Департамента по регулированию ТЭК при МЭ КР №103 от 24.04.2026
// (в рамках ПКМ КР №227 от 24.04.2025 — среднесрочная тарифная политика 2025-2030). Постановление Кабинета Министров КР (новые тарифы с 01.05.2026)
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-blue-800">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      <li>{getLocalized({ ru: 'Тарифы действуют с 01.05.2026 по 30.04.2027 (приказ Департамента по регулированию ТЭК №103 от 24.04.2026, в рамках ССТП 2025-2030).', ky: 'Тарифтер 01.05.2026дан 30.04.2027ге чейин колдонулат (ОЭК жөнгө салуу боюнча департаменттин 24.04.2026-жылдагы №103 буйругу, ССТП 2025-2030 алкагында).' })}</li>
                      <li>{getLocalized({ ru: 'Для населения и льготных семей применяется порог 700 кВт·ч, после которого включается повышенная ставка 2.94 сом.', ky: 'Калк жана жеңилдик алган үй-бүлөлөр үчүн 700 кВт·ч чек колдонулат, андан кийин 2.94 сомдук жогорку ставка иштейт.' })}</li>
                      <li>{getLocalized({ ru: 'С 01.05.2027 тарифы будут пересмотрены: по ССТП для населения запланировано 1.97 сом/кВт·ч, льготный тариф 0.50 сом сохраняется до 2030 года.', ky: '01.05.2027ден тартып тарифтер кайра каралат: ССТП боюнча калк үчүн 1.97 сом/кВт·ч пландалган, жеңилдетилген 0.50 сом чени 2030-жылга чейин сакталат.' })}</li>
                    </ul>
                    <p className="mt-3">
