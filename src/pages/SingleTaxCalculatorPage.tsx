...
const SINGLE_TAX_CONFIG = {
  trade_0_percent: {
    ...
    description: {
      ru: 'Для ИП с ККМ, не более 2 наёмных работников, без экспорта/импорта. Ставка 0% (действует с 01.04.2025)',
      ky: 'ККМ менен ЖИ, 2ден ашпаган жалданма кызматкер, экспорт/импортсуз. 0% чен (01.04.2025-жылдан бери)'
    },
    turnoverLabel: {
