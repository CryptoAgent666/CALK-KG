...
const SINGLE_TAX_CONFIG = {
  trade_0_percent: {
    name: {
      ru: 'ИП до 8 млн сом (ставка 0%)',
      ky: 'ЖИ 8 млн сомго чейин (0% чен)'
    },
    description: {
      ru: 'Для ИП с ККМ, не более 2 наёмных работников, без экспорта/импорта. Ставка 0% (действует с 01.01.2025)',
      ky: 'ККМ менен ЖИ, 2ден ашпаган жалданма кызматкер, экспорт/импортсуз. 0% чен (01.01.2025-жылдан бери)'
    },
    turnoverLabel: {
      ru: 'до 8 млн сом в год (ИП с ККМ)',
      ky: 'жылына 8 млн сомго чейин (ККМ менен ЖИ)'
    },
    rates: {
      cash: 0,
      cashless: 0
    ...
    minAnnualRevenue: 0,
    maxAnnualRevenue: 8000000
  },
  trade_30m: {
    name: {
      ru: 'Торговля до 30 млн сом в год',
      ky: 'Жылына 30 млн сомго чейин соода'
    },
    description: {
      ru: 'Для торговли с годовым оборотом до 30 млн сом в обновлении указана только безналичная ставка 0.5%',
      ky: 'Жылдык жүгүртүүсү 30 млн сомго чейин болгон соода үчүн жаңыртууда 0.5% нак эмес чен гана көрсөтүлгөн'
    },
    turnoverLabel: {
      ru: 'до 30 млн сом в год',
      ky: 'жылына 30 млн сомго чейин'
    },
    rates: {
      cash: null,
      cashless: 0.5
    ...
    minAnnualRevenue: 0,
    maxAnnualRevenue: 30000000
  },
  trade_50m: {
    name: {
      ru: 'Торговля 30-50 млн сом в год',
      ky: 'Жылына 30-50 млн сом соода'
    },
    description: {
      ru: 'Повышенный торговый коридор 30-50 млн сом: ставка 1% только для безналичной выручки',
      ky: '30-50 млн сом соода коридору: 1% чен нак эмес түшүүлөр үчүн гана'
    },
    turnoverLabel: {
      ru: '30-50 млн сом в год',
      ky: 'жылына 30-50 млн сом'
    },
    rates: {
      cash: null,
      cashless: 1
