...
const SINGLE_TAX_CONFIG = {
  ...
  catering_bishkek_osh: {
    name: {
      ru: 'Общепит (Бишкек и Ош)',
      ky: 'Коомдук тамактануу (Бишкек жана Ош)'
    },
    description: {
      ru: 'Общественное питание в городах Бишкек и Ош: 6% наличными / 4% безналичными (ст. 423 ч.5 НК КР)',
      ky: 'Бишкек жана Ош шаарларындагы коомдук тамактануу: накталай 6% / нак эмес 4% (НК 423-берене 5-б.)'
    },
    turnoverLabel: {
      ru: 'спецставка по виду деятельности',
      ky: 'ишмердик түрү боюнча атайын чен'
    },
    rates: {
      cash: 6,
      cashless: 4
  ...
  catering_regions: {
    name: {
      ru: 'Общепит (остальные регионы)',
      ky: 'Коомдук тамактануу (башка аймактар)'
    },
    description: {
      ru: 'Общественное питание вне Бишкека и Оша: 4% наличными / 2% безналичными (ст. 423 ч.5 НК КР)',
      ky: 'Бишкек менен Оштон тышкары коомдук тамактануу: накталай 4% / нак эмес 2% (НК 423-берене 5-б.)'
    },
    turnoverLabel: {
      ru: 'спецставка по виду деятельности',
      ky: 'ишмердик түрү боюнча атайын чен'
  ...
  sauna_billiard: {
    name: {
      ru: 'Сауны / бильярд / бани / лотереи',
      ky: 'Сауналар / бильярд / мончолор / лотереялар'
    },
    description: {
      ru: 'Лотерейная деятельность и услуги саун, бильярда и бань (кроме муниципальных): 8% независимо от формы оплаты (ст. 423 ч.4 НК КР)',
      ky: 'Лотерея ишмердиги жана сауна, бильярд, мончо кызматтары (муниципалдыктан башка): төлөм формасына карабай 8% (НК 423-берене 4-б.)'
    },
    turnoverLabel: {
      ru: 'спецставка по виду деятельности',
      ky: 'ишмердик түрү боюнча атайын чен'
  ...
  creative_park: {
    name: {
      ru: 'Парк креативных индустрий',
      ky: 'Креативдик индустриялар паркы'
    },
    description: {
      ru: 'Резиденты Парка креативных индустрий: 1% в 2025–2026 годах, с 2027 года — 2% (ст. 423 ч.6 НК КР). Резиденты ПВТ единый налог не платят (гл. 59 НК)',
      ky: 'Креативдик индустриялар паркынын резиденттери: 2025–2026-жылдары 1%, 2027-жылдан 2% (НК 423-берене 6-б.). ЖТП резиденттери бирдиктүү салык төлөбөйт (НК 59-глава)'
    },
    turnoverLabel: {
      ru: 'по условиям Парка креативных индустрий',
      ky: 'Креативдик индустриялар паркынын шарттары боюнча'
    },
    rates: {
      cash: 1,
      cashless: 1
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-700 text-white print:bg-white print:text-gray-900">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 print:py-6">
          ...
          <div className="mt-4 rounded-lg bg-white/10 p-3 text-sm text-red-50 print:hidden">
            {language === 'ky'
              ? 'Калькулятор нак/нак эмес түшүмдү, соода коридорлорун жана атайын чендерди өзүнчө эсептейт.'
              : 'Калькулятор отдельно учитывает наличную/безналичную выручку, торговые коридоры и специальные ставки.'}
          </div>
        </div>
      </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="text-sm text-yellow-800">
              ...
              <ul className="space-y-1">
                <li>• {language === 'ky' ? 'Чендер КР Салык кодексинин 423-беренеси менен 2026-жылдын августунда салыштырылган.' : 'Ставки сверены с Налоговым кодексом КР (ст. 423) в августе 2026 года.'}</li>
