...
const EMPLOYER_CONFIG = {
  business: {
    ...
    description: {
      ru: 'С 01.08.2024 действует сниженный тариф работодателя 2.25%: ПФ 1%, ФОМС 1%, ФОТ 0.25% (ст. 2-2 Закона о тарифах страховых взносов)',
      ky: '01.08.2024төн тартып жумуш берүүчү үчүн төмөндөтүлгөн чен 2.25%: ПФ 1%, ФОМС 1%, ФОТ 0.25% (Камсыздандыруу төлөмдөрүнүн тарифтери жөнүндө Мыйзамдын 2-2-беренеси)'
    },
    employerPFRate: 0.01,
  ...
  standard: {
    label: {
      ru: 'Бюджетные организации, банки, связь, недра, энергетика, алкоголь/табак/ГСМ',
      ky: 'Бюджеттик уюмдар, банктар, байланыш, жер казынасы, энергетика, алкоголь/тамеки/ГСМ'
    },
    description: {
      ru: 'Стандартный тариф работодателя 17.25%: ПФ 15%, ФОМС 2%, ФОТ 0.25%. По ст. 2-2 п. 3 сниженный тариф НЕ применяется к: организациям, финансируемым из госбюджета; горнодобывающим (недра общегосударственного значения); снабжению электро-, тепло- и газоэнергией; производству/импорту алкоголя, табака и ГСМ; сотовой связи; интернет-провайдерам; коммерческим банкам и финансово-кредитным учреждениям',
      ky: 'Жумуш берүүчүнүн стандарттык чени 17.25%: ПФ 15%, ФОМС 2%, ФОТ 0.25%. 2-2-берененин 3-пункту боюнча төмөндөтүлгөн чен КОЛДОНУЛБАЙТ: мамбюджеттен каржыланган уюмдарга; жалпы мамлекеттик мааниси бар жер казынасын иштеткен ишканаларга; электр, жылуулук жана газ менен камсыздоого; алкоголь, тамеки жана ГСМ өндүрүү/импорттоого; уюлдук байланышка; интернет-провайдерлерге; коммерциялык банктарга жана каржы-кредиттик мекемелерге'
    },
    employerPFRate: 0.15,
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-blue-800">
                    <p className="font-medium mb-2">
                      {language === 'ky' ? '2026-жылга карата түзүм (Мыйзамдын 22.07.2026-жылдагы редакциясы)' : 'Структура расчёта на 2026 год (редакция закона от 22.07.2026)'}
                    </p>
                    ...
                    <div className="mt-4 pt-3 border-t border-blue-200">
                      <p className="font-medium mb-2">{language === 'ky' ? 'Мыйзамдагы өзгөчө тарифтер (калькуляторго кирбейт):' : 'Особые тарифы в законе (калькулятором не покрываются):'}</p>
                      <ul className="list-disc list-inside ml-1 space-y-1">
                        <li>{language === 'ky'
                          ? 'ЖИ (салык режимине карабай): айына СМЗдан кеминде 6% (6-берене)'
                          : 'ИП (независимо от налогового режима): не менее 6% от среднемесячной зарплаты в месяц (ст. 6)'}</li>
                        <li>{language === 'ky'
                          ? 'Тигүү жана текстиль өнөр жайы (2030-жылга чейин): иш берүүчү — СМЗдын 40%ынан 2%; кызматкер — СМЗдын 40%ынан 10% (2-1-берене)'
                          : 'Швейная и текстильная промышленность (до 2030 года): работодатель — 2% от 40% СМЗ; работник — 10% от 40% СМЗ (ст. 2-1)'}</li>
                        <li>{language === 'ky'
                          ? 'ЖТП жана Креативдик индустриялар паркынын кызматкерлери: СМЗдан 12% (ПФ 10% + МТПФ 2%), иш берүүчү төлөбөйт (7-1, 7-2-беренелер)'
                          : 'Работники ПВТ и Парка креативных индустрий: 12% от СМЗ (ПФ 10% + ГНПФ 2%), работодатель взносы не платит (ст. 7-1, 7-2)'}</li>
                        <li>{language === 'ky'
                          ? '1964-жылга чейин туулган эркектер, 1969-жылга чейинки аялдар жана иштеген пенсионерлер МТПФга төлөбөйт — бардык 10% Пенсиялык фондго (11-1-берене)'
                          : 'Мужчины, рождённые до 1964 года, женщины до 1969 года и работающие пенсионеры не платят в ГНПФ — все 10% идут в Пенсионный фонд (ст. 11-1)'}</li>
                      </ul>
                    </div>
                  </div>
                </div>
