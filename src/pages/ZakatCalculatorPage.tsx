...
const ZAKAT_CONFIG = {
  ...
  // ⚠️ Это РЫНОЧНАЯ цена, а не константа из приказа: двигается постоянно, и вместе
  // с ней двигается нисаб (85 г × цену). Прежние 14 200 от 21.04.2026 завышали порог
  // на ~3%: человек с накоплениями между 1,17 и 1,21 млн сом считался обязанным
  // платить закят по факту, но калькулятор говорил, что нисаб не достигнут.
  gold_price_per_gram: 13752 // сом за грамм, цена продажи ОАО «Кыргызалтын» на 17.08.2026
