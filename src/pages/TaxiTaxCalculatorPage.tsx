        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 print:py-6">
          <div className="text-center">
            ...
            <div className="mx-auto mt-6 max-w-3xl rounded-xl bg-white/10 p-4 text-left text-sm text-blue-50 print:hidden">
              {language === 'ky'
                ? 'Март 2026 жаңыртуусу: агрегатор иштеген такси жана курьер режиминде 1% киреше салыгынын үстүнө 1% соцтөгүм да кармалат.'
                : 'Обновление марта 2026: для такси и курьеров через агрегатор помимо 1% подоходного налога удерживается ещё 1% социальных взносов.'}
            </div>
          </div>
        </div>
      </div>
