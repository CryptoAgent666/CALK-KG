...
- **Подоходный налог 10%** standard / **5%** for ПВТ (High-Tech Park) residents. Стандартные вычеты
  ...
  **1 РП = 100 сом/мес** (1 расчётный показатель = 100 сом). «НМД 14 970» — в НК такого числа нет. Соцфонд **10%** employee (8% ПФ + 2% ГНПФ). Employer: **17,25%** (ПФ 15 + ФОМС 2 + ФОТ 0,25 —
  ст.2) либо **2,25%** (ПФ 1 + ФОМС 1 + ФОТ 0,25 — ст.2-2, с 01.08.2024). Сниженная ставка НЕ
  применяется (ст.2-2 ч.3) к бюджетным организациям, недропользователям, энерго/тепло/газоснабжению,
  производству/импорту алкоголя, табака и ГСМ, сотовой связи, интернет-провайдерам, банкам и
  фин-кредитным учреждениям. «27,25%» — это СОВОКУПНАЯ нагрузка (17,25 работодатель + 10 работник),
  а не ставка работодателя. Пределы базы (ст.13): не менее 60% СМЗ (ст.2) / 100% СМЗ (ст.2-2),
  совокупно не более 20×СМЗ за предыдущий год (СМЗ-2026 = 36 047 сом). Verified verbatim 2026-07-27.
